...
% r_dot parameters are expressed in km/s
	...
	\[
	\prescript{\mathcal{N}}{}{\hat{i}_r} = \frac{\boldsymbol{r}_{LMO}}{\|\boldsymbol{r}_{LMO}\|}
	\]
	
	\[
	\prescript{\mathcal{N}}{}{\hat{i}_h} = \frac{\boldsymbol{r}_{LMO} \times \boldsymbol{\dot{r}}_{LMO}}{\|\boldsymbol{r}_{LMO} \times \boldsymbol{\dot{r}}_{LMO}\|}
	\]
	
	\[
	\prescript{\mathcal{N}}{}{\hat{i}_\theta} = \hat{i}_h \times \hat{i}_r
	\]
	
	To drive a DCM with the base vectors in either frames, we have:
	$$[C]_{\mathcal{F}\mathcal{B}} = 
	\begin{bmatrix}
	...
	Therefore, to find $[C]_{\mathcal{H}\mathcal{N}}$ we will have:
	$$[C]_{\mathcal{H}\mathcal{N}} = 
	\begin{bmatrix}
		\prescript{\mathcal{N}}{}{\hat{i}_r} ^ T \\
		\prescript{\mathcal{N}}{}{\hat{i}_\theta} ^ T \\
		\prescript{\mathcal{N}}{}{\hat{i}_h} ^ T
	\end{bmatrix}$$
...
HN_DCM = [i_r';i_theta';i_h'];
	...
	$$[C]_{\mathcal{R}_s\mathcal{N}} = 
	\begin{bmatrix}
		\prescript{\mathcal{N}}{}{\hat{r}_1} ^ T \\
		\prescript{\mathcal{N}}{}{\hat{r}_2} ^ T \\
		\prescript{\mathcal{N}}{}{\hat{r}_3} ^ T
	\end{bmatrix}
	= \begin{bmatrix}
		-1 & 0 & 0 \\
		0 & 0 & 1 \\
...
rotation = M1(pi/2)*M3(pi);
	...
	$$[C]_{\mathcal{R}_n\mathcal{H}} = M_1(\pi)M_3(\pi)$$
	
	
	 We also had previously obtained $[C]_{\mathcal{H}\mathcal{N}}$ in task 2 as a function of time. So,
	 
	 $$[C]_{\mathcal{R}_n\mathcal{N}} (t) = [C]_{\mathcal{R}_n\mathcal{H}}[C]_{\mathcal{H}\mathcal{N}}(t) $$
