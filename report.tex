...
w_BR = w_BN - BN*w_RN;
	...
	The MRP confirms it all. The spacecraft goes crazily oscillating when the control torque $\boldsymbol{u}_2$ is applied to it (Figure~\ref{fig:u2_sigma}). This suggests that $\boldsymbol{u}_2$ fails as a successful control, making the craft uncontrollable rather that detumbling it. 
